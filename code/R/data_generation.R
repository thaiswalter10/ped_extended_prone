...
# This code generates data which mimick the one from the underlying article: 
...
# save the three files: demographics / pressure injuries and propositioning data on local computer". 
